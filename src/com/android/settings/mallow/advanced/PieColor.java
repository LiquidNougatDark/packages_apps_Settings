...
public class PieColor extends SettingsPreferenceFragment
        implements OnPreferenceChangeListener {

    private static final String TAG = "PieColor";
    ...
    private SwitchPreference mEnableColor;
    ...
    private ColorPickerPreference mChevron;
    ...
    public void refreshSettings() {
        ...
        boolean enableColor = Settings.System.getInt(getContentResolver(),
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            switch (id) {
                case DLG_RESET:
                    ...
                    .setPositiveButton(R.string.reset_mallow,
                        new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Settings.System.putInt(getOwner().getContentResolver(),
                                    Settings.System.PA_PIE_ENABLE_COLOR, 1);
