...
public class NavigationBar extends SettingsPreferenceFragment
    ...
    private static final String PREF_STYLE_DIMEN = "navbar_style_dimen";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMenuDisplayLocation.setValue(Settings.System.getInt(getContentResolver(),
        	    Settings.System.MENU_LOCATION, 0) + "");
        mMenuDisplayLocation.setOnPreferenceChangeListener(this);

        mNavBarMenuDisplay = (ListPreference) findPreference(PREF_NAVBAR_MENU_DISPLAY);
        mNavBarMenuDisplayValue = Settings.System.getInt(getContentResolver(),
